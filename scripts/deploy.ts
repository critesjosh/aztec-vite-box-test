import { BoxReactContractArtifact, BoxReactContract } from "../src/contracts/src/artifacts/BoxReact.js"
...
async function main() {
    ...
    const boxContract = await BoxReactContract.deploy(wallet, 2, address).send().deployed();
    logger.info(`Box React Contract deployed at: ${boxContract.address}`);
}
